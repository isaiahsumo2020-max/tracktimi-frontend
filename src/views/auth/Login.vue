<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-50 to-orange-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full">
      <h1 class="text-3xl font-bold text-gray-800 text-center mb-8">TrackTimi</h1>
      ...
      <p class="text-center mt-4 text-sm text-gray-600">
        No org? <router-link to="/register-org" class="text-orange-500 hover:underline">Register Organization</router-link>
      </p>
    </div>
  </div>
</template>
